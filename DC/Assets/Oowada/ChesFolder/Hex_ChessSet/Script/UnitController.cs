...
public class UnitController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (TYPE.PAWN == Type) {TrueType= csvDatas[0][0]; hp = int.Parse(csvDatas[0][1]); maxHp = int.Parse(csvDatas[0][1]); point = int.Parse(csvDatas[0][2]); }
        if (TYPE.ROOK == Type) {TrueType = csvDatas[1][0]; hp = int.Parse(csvDatas[1][1]); maxHp = int.Parse(csvDatas[1][1]); point = int.Parse(csvDatas[1][2]); }
        if (TYPE.KNIGHT == Type) {TrueType = csvDatas[2][0]; hp = int.Parse(csvDatas[2][1]); maxHp = int.Parse(csvDatas[2][1]); point = int.Parse(csvDatas[2][2]); }
        if (TYPE.BISHOP == Type) {TrueType = csvDatas[3][0]; hp = int.Parse(csvDatas[3][1]); maxHp = int.Parse(csvDatas[3][1]); point = int.Parse(csvDatas[3][2]); }
